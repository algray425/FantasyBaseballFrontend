        ...
        Row(children: [
          ...
          Consumer<HitterListModel>(
            builder: (context, hitterListModel, child) {
              return SeasonSelector(pageType: PageType.HITTER_RANKINGS, callback: Provider.of<HitterListModel>(context, listen: false).updateSeason);
            }
          ),
          Container(
              margin: EdgeInsets.fromLTRB(10, 0, 10, 0),
          ...
          Consumer<HitterListModel>(
            builder: (context, hitterListModel, child) {
              return PositionSelector(pageType: PageType.HITTER_RANKINGS, callback: Provider.of<HitterListModel>(context, listen: false).updatePositions);
            }
          ),
          Container(
              margin: EdgeInsets.fromLTRB(10, 0, 10, 0),
          ...
          Consumer<HitterListModel>(
            builder: (context, hitterListModel, child) {
              return LeagueSelector(userId: "1", pageType: PageType.HITTER_RANKINGS, callback: Provider.of<HitterListModel>(context, listen: false).updateTeamFilter);
            }
          ),
          Consumer<HitterListModel>(
            builder: (context, hitterListModel, child) {
              return DateRangeSelector(pageType: PageType.HITTER_RANKINGS, callback: Provider.of<HitterListModel>(context, listen: false).updateDateRanges);
            }
          )
        ]),
