                            ...
                            child: Container(
                                ...
                                child: Row(
                                    children: [
                                      ...
                                      Expanded(child: Container(alignment: Alignment.center, child: Text("Avg Ex Velo", style: TextStyle(fontSize: 12)))),
                                      ...
                                      Expanded(child: Container(alignment: Alignment.center, child: Text("CSW%", style: TextStyle(fontSize: 12)))),
                              ...
                              child: Container(
                                  ...
                                  child: Row(
                                      children: [
                                        ...
                                        Expanded(child: Container(alignment: Alignment.center, child: Text((summary.csw * 100.0).toStringAsFixed(1), style: TextStyle(fontSize: 12)))),
